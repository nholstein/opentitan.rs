#[doc = "Reader of register RXF_ADDR"]
pub type R = crate::R<u32, super::RXF_ADDR>;
#[doc = "Writer for register RXF_ADDR"]
pub type W = crate::W<u32, super::RXF_ADDR>;
#[doc = "Register RXF_ADDR `reset()`'s with value 0x01fc_0000"]
impl crate::ResetValue for super::RXF_ADDR {
    type Type = u32;
    #[inline(always)]
