#[doc = "Reader of register CLASSA_CTRL"]
pub type R = crate::R<u32, super::CLASSA_CTRL>;
#[doc = "Writer for register CLASSA_CTRL"]
pub type W = crate::W<u32, super::CLASSA_CTRL>;
#[doc = "Register CLASSA_CTRL `reset()`'s with value 0x393c"]
impl crate::ResetValue for super::CLASSA_CTRL {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bit 0 - Enable escalation mechanisms (accumulation and interrupt timeout) for Class A. Note that interrupts can fire regardless of whether the escalation mechanisms are enabled for this class or not."]
    #[inline(always)]
    pub fn en(&self) -> EN_R {
        EN_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - Enable automatic locking of escalation counter for class A. If true, there is no way to stop the escalation protocol for class A once it has been triggered."]
    #[inline(always)]
    pub fn lock(&self) -> LOCK_R {
        LOCK_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 2 - Enable escalation signal 0 for Class A"]
    #[inline(always)]
    pub fn en_e0(&self) -> EN_E0_R {
        EN_E0_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    #[doc = "Bit 3 - Enable escalation signal 1 for Class A"]
    #[inline(always)]
    pub fn en_e1(&self) -> EN_E1_R {
        EN_E1_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    #[doc = "Bit 4 - Enable escalation signal 2 for Class A"]
    #[inline(always)]
    pub fn en_e2(&self) -> EN_E2_R {
        EN_E2_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    #[doc = "Bit 5 - Enable escalation signal 3 for Class A"]
    #[inline(always)]
