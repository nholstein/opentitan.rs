...
impl R {
    #[doc = "Bit 0 - HMAC-256 completes a message with key"]
    #[inline(always)]
    pub fn hmac_done(&self) -> HMAC_DONE_R {
        HMAC_DONE_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - Message FIFO full condition"]
    #[inline(always)]
    pub fn fifo_full(&self) -> FIFO_FULL_R {
        FIFO_FULL_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 2 - HMAC error occurred. ERR_CODE register shows which error occurred"]
    #[inline(always)]
