...
impl R {
    #[doc = "Bit 0 - Enable interrupt when !!INTR_STATE.prog_empty is set"]
    #[inline(always)]
    pub fn prog_empty(&self) -> PROG_EMPTY_R {
        PROG_EMPTY_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - Enable interrupt when !!INTR_STATE.prog_lvl is set"]
    #[inline(always)]
    pub fn prog_lvl(&self) -> PROG_LVL_R {
        PROG_LVL_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 2 - Enable interrupt when !!INTR_STATE.rd_full is set"]
    #[inline(always)]
    pub fn rd_full(&self) -> RD_FULL_R {
        RD_FULL_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    #[doc = "Bit 3 - Enable interrupt when !!INTR_STATE.rd_lvl is set"]
    #[inline(always)]
    pub fn rd_lvl(&self) -> RD_LVL_R {
        RD_LVL_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    #[doc = "Bit 4 - Enable interrupt when !!INTR_STATE.op_done is set"]
    #[inline(always)]
    pub fn op_done(&self) -> OP_DONE_R {
        OP_DONE_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    #[doc = "Bit 5 - Enable interrupt when !!INTR_STATE.op_error is set"]
    #[inline(always)]
